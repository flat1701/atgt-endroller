...
'<div class="w3w">what3words：<br>'+this.w3w+'</div><br>'+
'<div class="author">作問：<br>'+this.author.join("<br>")+'</div><br>'+
'<div class="debug">検証とデバッグ：<br>'+this.debug.join("<br>")+'</div><br>'+
'<div class="tensai">甜菜：<br>'+this.tensai.join("<br>")+'</div>');
});
